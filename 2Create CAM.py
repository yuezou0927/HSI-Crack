...
image_file_path = 'crack_data_Leeds/train/traindata/0'
CAM_output_folder = 'Leeds model/1111result/1111CAM'
CAM_output_binary = 'Leeds model/1111result/1111binary'
model_path = 'Leeds model/1111result/1111CAM_model.pth'
##################################################################################
...
class mymodel(nn.Module):
    def __init__(self, in_channel,classnum=2):
        ...
        self.final = nn.Conv2d(17, classnum, 3, 1, 1)
...
if not os.path.exists(CAM_output_binary):
    os.makedirs(CAM_output_binary)
...
for filename in os.listdir(image_file_path):
    ...
    if filename.endswith('.npy'): 
        ...
        if classes[idx[0]] == "crack":
            ...
            inverted_heatmap = cv2.bitwise_not(binary_heatmap)
